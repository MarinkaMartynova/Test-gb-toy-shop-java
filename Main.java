public class Main {
    public static void main(String[] args) {
        ...
        Toy bear = new Toy(1, "Мишка плюшевый");
        Toy car = new Toy(2, "Машинка");
        Toy doll = new Toy(3, "Кукла");
        Toy lego = new Toy(4, "Lego");
        Toy robot = new Toy(5, "Робот");
        Toy monopoly = new Toy(6, "Монополия");
        ...
        toy_lottery.add_toy_in_listToy(robot);
        toy_lottery.add_toy_in_listToy(monopoly);
